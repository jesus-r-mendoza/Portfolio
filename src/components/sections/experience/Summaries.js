        ...
        <div className="d-flex justify-content-between flex-wrap my-5">
            ...
            <div className="summary">
                ...
                <p className="lead">
                    ...
                    to implement all of the features we need for <strong>ODAS</strong>. Our Backend serves as an REST API, which
            ...
            <div className="summary">
                ...
                <p className="lead">
                    ...
                    behaviour based on the historical data for the provided component on the satellite. Since we're working with time-series
            ...
            <div className="summary">
                ...
                <p className="lead">
                    ...
                    our compute, storage, and database neccessities. From AWS, we're using RDS to manage our MySql Database, EC2 for our
            ...
            <div className="summary">
                <h5>Database</h5>
                <p className="lead">
                    <strong>ODAS</strong> provides a lot of functionality which includes User and Organization registeration, Token Authentication
