        ...
        <div className="d-flex justify-content-between flex-wrap my-5">
            <div className="summary">
                ...
                <p>
                    ...
                    ducimus magnam soluta error, nisi enim provident tenetur saepe aspernatur
                    blanditiis numquam, eum quia veritatis amet quis? Repudiandae fuga ipsam provident
                    laboriosam obcaecati deleniti sequi voluptate delectus maxime sed quisquam
                </p>
            </div>
            <div className="summary">
                <h5>Title</h5>
